    ...
    <div class="wrapper_geral interno">
        ...
        <div class="container interno" style="height: 500px;">
            ...
            <div class="tituloTexto">
                ...
                <div class="textoPrincipal"><strong>Maria Catarina Duncan</strong></div>

                <div class="texto interno">é assistente de coordenação do programa COINCIDÊNCIA - Intercâmbios Culturais Suíça América do Sul, da Fundação Suíça para Cultura Pro Helvetia. Colaborou com o projeto de arte e educação no Solar dos Abacaxis, no Rio de Janeiro, e na manutenção constelar do projeto <i>Terreyro Coreográfico</i>, em São Paulo. Foi assistente curatorial na 32ª Bienal de São Paulo, <i>Incerteza Viva</i>. Participou das residências artísticas Lastro Travessias Ocultas, na Bolívia, e Lastro Centro América, na Guatemala, e foi pesquisadora para a exposição <i>Lastro em Campo - Percursos ancestrais e contemporâneos</i>, no Sesc Consolação. Integrou a equipe curatorial do Pivô Arte e Pesquisa, e foi assistente de curadoria para as exposições <i>Terra Comunal - Marina Abramovic</i>, no Sesc Pompeia; <i>Alter-Heróis</i>, no MAC – USP Ibirapuera; e <i>Still Being</i>, do artista Antony Gormley, no Centro Cultural Banco do Brasil.</div>
                ...
                <p><strong>Maria Catarina Duncan</strong> é assistente de coordenação do programa COINCIDÊNCIA - Intercâmbios Culturais Suíça América do Sul, da Fundação Suíça para Cultura Pro Helvetia. Colaborou com o projeto de arte e educação no Solar dos Abacaxis, no Rio de Janeiro, e na manutenção constelar do projeto <i>Terreyro Coreográfico</i>, em São Paulo. Foi assistente curatorial na 32ª Bienal de São Paulo, <i>Incerteza Viva</i>. Participou das residências artísticas Lastro Travessias Ocultas, na Bolívia, e Lastro Centro América, na Guatemala, e foi pesquisadora para a exposição <i>Lastro em Campo - Percursos ancestrais e contemporâneos</i>, no Sesc Consolação. Integrou a equipe curatorial do Pivô Arte e Pesquisa, e foi assistente de curadoria para as exposições <i>Terra Comunal - Marina Abramovic</i>, no Sesc Pompeia; <i>Alter-Heróis</i>, no MAC – USP Ibirapuera; e <i>Still Being</i>, do artista Antony Gormley, no Centro Cultural Banco do Brasil.</p>
